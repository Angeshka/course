...
public class Zatraty {
    ...
    public Zatraty(String one_client, String duration, String transport, String hotel, String escort, String wage_escort) {
        this.one_client = one_client;
        this.duration = duration;
        this.transport = transport;
        this.hotel = hotel;
